...
<body>
    ...
    <section id="auth_section">
		...
		if (isset($_POST['user_login_submit'])) {
		    ...
		    $sql = "SELECT * FROM signup WHERE Email = '$sanitized_Email'";		    
			...
			while($row=mysqli_fetch_assoc($result)){
		        ...
		        $sanitized_Password = mysqli_real_escape_string($conn, $Password);
                        ...
                        $sql = "SELECT * FROM emp_login WHERE Emp_Email = '".$sanitized_Email."' AND Emp_Password = BINARY'".$sanitized_Password."'";
                        $result = mysqli_query($conn, $sql);
